...
namespace Platformer
{
    public class SpriteAnimatorController : IDisposable
    {
        ...
        private sealed class AnimationTurner
        {
        ...
        private Dictionary<SpriteRenderer, AnimationTurner> _activeAnimations = new Dictionary<SpriteRenderer, AnimationTurner>();
        ...
        public void StartAnimation(SpriteRenderer spriteRenderer, AnimState track, bool loop, float speed)
        {
            ...
            {
                _activeAnimations.Add(spriteRenderer, new AnimationTurner()
                {
                    Track = track,
